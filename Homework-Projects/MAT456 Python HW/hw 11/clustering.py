...
#THIS IS MY FUNCTION TO FIND SUM OF SQUARED ERROR OF THE COLORS ASSIGNED VS ACTUAL
...
def recolor_image(input_file, k=5):
    path_to_png_file = '../niqson/gillet.png'
    ...
    new_img = [[recolor(pixel) for pixel in row]
               for row in img]
    new_pixels = [pixel for row in new_img for pixel in row]

    print 'Sum Squared error of Assigned colors: '
    print squared_clustering_errors_pixels(pixels, new_pixels)
